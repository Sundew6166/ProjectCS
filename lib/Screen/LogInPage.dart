            ...
            child: Column(
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(labelText: "ชื่อผู้ใช้", icon: Icon(Icons.person)),
                ),
                TextFormField(
                  onTapOutside: (PointerDownEvent event) => FocusScope.of(context).requestFocus(_unUsedFocusNode),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      setState(() => _errorFromFirebase = null);
                      if (_loginFormKey.currentState!.validate()) {
                        try {
                          await AccountController().login(_textEditUsername.text, _textEditPassword.text)
                            .then((value) => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BottomBar(accType: value, tab: "HOME"))));
                        } on FirebaseAuthException catch (e) {
                          print(e.code);
                          setState(() => _errorFromFirebase = "ชื่อผู้ใช้หรือรหัสผ่านไม่ถูกต้อง");
                        }
                      }
                    },
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: const Text("ลงทะเบียน", style: TextStyle(color: Color(0xff795e35), fontWeight: FontWeight.bold)),
                      )
                    ],
                  )
                )
