                    ...
                    Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: Container(
                            child: _image != null ? Image.file(_image!, fit: BoxFit.cover) : const Text("กรุณาเลือกรูป")
                          )
                        ),
                        Center(
                        ...
                        TextFormField(
                          ...
                          textInputAction: TextInputAction.next,
                          validator: (value) => (value!.isEmpty) ? "กรุณากรอกราคาที่จะขาย" : (int.parse(value) > 0) ? null : "ราคาขายต้องมากกว่า 0",
                        ...
                        TextFormField(
                          ...
                          keyboardType: TextInputType.number,
                          textInputAction: TextInputAction.next,
                          validator: (value) => (value!.isEmpty) ? "กรุณากรอกค่าส่ง" : (int.parse(value) >= 0) ? null : "ค่าส่งต้องไม่ติดลบ",
                          decoration: const InputDecoration(labelText: "ค่าส่ง"),
                        ),
                        TextFormField(
                          onTapOutside: (PointerDownEvent event) => FocusScope.of(context).requestFocus(_unUsedFocusNode),
                              ...
                              if (_image == null) {
                                showDialog(
                                  ...
                                  builder: (_) => AlertDialog(
                                    title: const Text("กรุณาเพิ่มรูปสภาพหนังสือเล่มที่จะขาย"),
                                    content: const Text("กรุณาเพิ่มรูปสภาพหนังสือเล่มที่จะขาย"),
                                    actions: [
                                      TextButton(
                                ...
                                showDialog(
                                  context: context,
                                  builder: (_) => AlertDialog(
                                    title: const Text("ยืนยันเพื่อเพิ่มไปยังการขาย"),
                                    content: const Text("ยืนยันเพื่อเพิ่มไปยังการขาย"),
                                    actions: <Widget>[
                                      TextButton(
                                        onPressed: () async {
                                          try {
                                              ...
                                              .then((value) {
                                                showDialog(
                                                  ...
                                                  builder: (_) => AlertDialog(
                                                    ...
                                                    content: const Text("เพิ่มการขายหนังสือเสร็จสิ้น"),
                                                    actions: <Widget>[
                                                      TextButton(
