            ...
            children: [
              Container(
                ...
                child: Column(children: [
                  Book(title: widget.saleInfo["title"], price: widget.saleInfo["sellingPrice"]),
...
class Book extends StatelessWidget {
  Book({super.key, required this.title, required this.price});
  String title;
  int price;
        ...
        children: <Widget>[
          Expanded(
            child: Align(
              ...
              child: Text(title, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 20)),
            ),
          ),
          Expanded(
            child: Align(
