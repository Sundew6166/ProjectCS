                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  icon: Icon(isCurPasswordVisible ? Icons.visibility : Icons.visibility_off),
                                  onPressed: () => setState(() => isCurPasswordVisible = !isCurPasswordVisible),
                                ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  icon: Icon(isConPasswordVisible ? Icons.visibility : Icons.visibility_off),
                                  onPressed: () => setState(() => isConPasswordVisible = !isConPasswordVisible),
                                ),
                                icon: const Icon(Icons.vpn_key)
                              ),
                            ),
                                  ...
                                  try {
                                    await AccountController().changePassword(_textEditCurPassword.text, _textEditConPassword.text)
                                      .then((value) => showDialog(
                                        ...
                                        builder: (_) => AlertDialog(
                                          ...
                                          content: const Text("การเปลี่ยนรหัสผ่านของคุณเสร็จสิ้น"),
                                          actions: <Widget>[
                                            TextButton(
                                    ...
                                    showDialog(
                                      ...
                                      builder: (_) => AlertDialog(
                                        ...
                                        content: const Text("เกิดข้อผิดพลาดในการเปลี่ยนรหัสผ่าน กรุณาลองใหม่"),
                                        actions: <Widget>[
                                          TextButton(
