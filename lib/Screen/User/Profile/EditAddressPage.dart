                      ...
                      Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (value) => (value!.isNotEmpty && value.length != 10) ? "กรอกเบอร์โทรศัพท์ไม่ถูกต้อง" : null,
                            decoration: const InputDecoration(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                if (_addressFormKey.currentState!.validate()) {
                                  try {
                                    await AccountController().updateDeliveryInformation({"name": _textEditName.text, "address": _textEditAddress.text, "phone": _textEditPhone.text})
                                      .then((value) => showDialog(
                                        context: context,
                                        builder: (_) => AlertDialog(
                                          title: const Text("เสร็จสิ้น"),
                                          content: const Text("การแก้ไขข้อมูลการจัดส่งของคุณเสร็จสิ้น"),
                                          actions: <Widget>[
                                            TextButton(
                                    ...
                                    showDialog(
                                      ...
                                      builder: (_) => AlertDialog(
                                        ...
                                        content: const Text("เกิดข้อผิดพลาดในการแก้ไขข้อมูลการจัดส่ง กรุณาลองใหม่"),
                                        actions: <Widget>[
                                          TextButton(
