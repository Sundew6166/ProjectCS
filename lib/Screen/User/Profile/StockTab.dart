...
class _StockTabState extends State<StockTab> {
  ...
  Future<void> setData() async {
    await BookController().getAllBookInLibrary(widget.accType)
      .then((value) => setState(() => widget.bookList = value));
  }
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        if (widget.accType == "ADMIN") {
                          Navigator.push(context, MaterialPageRoute(builder: (_) => AddBook(accType: widget.accType, bookInfo: bookInfo)));
                        } else {
                          Navigator.push(context, MaterialPageRoute(builder: (_) => ReviewPage(bookInfo: bookInfo, hasBook: true, hasSale: false)));
                        }
                      },
                      child: SizedBox(
                        height: 100,
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Image.network(widget.bookList[index]!["coverImage"]),
                                ),
                                Expanded(
                                  child: Padding(
