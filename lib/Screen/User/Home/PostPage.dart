          ...
          child: Column(
            children: [
              TextFormField(
                ...
                maxLines: 8,
                validator: (value) => value!.isEmpty ? "ข้อมูลไม่ถูกต้อง" : null,
              ...
              ElevatedButton(
                onPressed: () async {
                  if (_keyValidationForm.currentState!.validate()) {
                    String accT = await AccountController().getAccountType();
                    try {
                      await PostController().addPost(textarea.text)
                        .then((value) => Navigator.push(context, MaterialPageRoute(builder: (context) => BottomBar(accType: accT, tab: "HOME"))));
