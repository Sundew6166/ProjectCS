...
class _SaleTabState extends State<SaleTab> {
  ...
  Future<void> setData() async {
    if (widget.page == "home") {
      await SaleController().getAllSale()
        .then((value) => setState(() => saleList = value));
    } else {
      await SearchController().getSales(widget.text!)
        .then((value) => setState(() => saleList = value));
    }
  }
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, index) {
                      return GestureDetector(
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => BuyPage(saleInfo: saleList![index]))),
                        child: Card(
                          child: Container(
