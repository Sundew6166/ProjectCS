...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> setData() async {
    await NotificationController().getListNoti()
      .then((value) => setState(() => noti = value));
  }
                ...
                actions: [
                  Badge(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => NotificationPage(notiList: noti!["notiList"]))),
                    )
                  ),
                  IconButton(
