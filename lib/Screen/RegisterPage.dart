...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final TextEditingController _textEditConfirmPassword = TextEditingController();
              ...
              child: WillPopScope(
                onWillPop: () async {
                  ...
                  if (presscount == 2) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(snackBar).closed.then((value) => presscount = 0);
                    return false;
                  }
                },
                child: Padding(
                      ...
                      if (_registerFormKey.currentState!.validate()) {
                        try {
                          await AccountController().register(_textEditUsername.text, _textEditPassword.text, _textEditName.text, _textEditAddress.text, _textEditPhone.text)
                            .then((value) => Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => BottomBar(accType: "USER", tab: "HOME"))));
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: const Text("เข้าสู่ระบบ", style: TextStyle(color: Color(0xff795e35), fontWeight: FontWeight.bold)),
                      )
                    ],
                  )
                )
